...
public class StudentRowMapper implements RowMapper {
    ...
    @Override
    /**
     * This method is used to map a row of data from a ResultSet object to a Student object. The mapRow() method takes two
     * parameters: a ResultSet object and an integer rowNum, which represents the current row number. It throws a
     * SQLException if an error occurs while accessing the result set. A new Student object is created, and its properties
     ...
     * The method returns the Student object that was created and populated with the data from the ResultSet.
     */
